...
<div class="row">
  <div class="column middle">
    ...
    <div class="textpage">
      ...
      <?php
      if(isset($_POST['fautor'])||isset($_POST['title'])){ // Condicion para saber si se ha buscado autor o no.
        // filtrará los ebooks que se mostrarán en la página
        // AHORA TOCA CAMBIAR LA CONSULTA PARA MOSTRAR LOS LIBROS QUE HAYAMOS BUSCADO
        $query="SELECT Books.Description, Books.img, Books.Title  FROM Books 
        INNER JOIN BooksAuthors ON Id=BooksAuthors.BookId
        ...
        // Si no se encuentra autor uscado se mostraran todos los datos
        //mostrará todos los ebooks de la DB
        // 2. Selección y muestra de datos de la base de datos
        $result = mysqli_query($conn, "SELECT Books.Description, Books.img, Books.Title FROM Books WHERE eBook != '0'");
      }
      // Una vez hecha la consulta, mostramos los datos
